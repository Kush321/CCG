...
var coinG, wallG, playerG, borderG, laserG, colorG;
var key1, key2;
var plrSpeed = 5;
var amt = 8;
var bls, grs, yes, res;
...
function draw() {
  ...
  if (gameState === START1) {
    textSize(20);
    fill("white");
    text("PLAYER - CHOOSE YOUR COLOR", 30, 100);
...
function playerMovement() {
  //AI PLAYER
  if(plr1.x===20&&plr1.y===20){
      plr1.velocityY=plrSpeed;
      plr1.velocityX=0;
  }
  if(plr1.x===20&&plr1.y===370){
      plr1.velocityX=plrSpeed;
      plr1.velocityY=0;
  }
  plr1.bounceOff(wallG)
  if(plr1.x===260&&plr1.y===370){
      plr1.velocityX=0;
      plr1.velocityY=-plrSpeed;
  }
  if(plr1.x===260&&plr1.y===20){
    plr1.velocityX=0;
    plr1.x=plr1.x-1
    plr1.velocityY=plrSpeed;
  }
  if(plr1.x===259&&plr1.y===370){
    plr1.velocityX=-plrSpeed;
    plr1.velocityY=0;
    plr1.y=plr1.y-1;
    console.log("frwfdbv");
  }
  if(plr1.x===21&&plr1.y===369){
    plr1.velocityX=0;
    plr1.velocityY=-plrSpeed;
    console.log("frwfdbv");
  }
 /* if(plr1.x===21&&plr1.y===300){
    plr1.velocityX=plrSpeed;
    plr1.y=plr.y+1;
    plr1.velocityY=0;
  }*/
